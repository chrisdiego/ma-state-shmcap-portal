...
index.addDoc(risks2);
index.addDoc(risks3);
index.addDoc(capabilities1);
index.addDoc(strategy1);
index.addDoc(strategy2);
index.addDoc(strategy3);
index.addDoc(team1);
index.addDoc(team2);
index.addDoc(team3);
index.addDoc(team4);
index.addDoc(glossary1);
index.addDoc(fullplan1);
index.addDoc(fullplan2);
index.addDoc(fullplan3);
index.addDoc(fullplan4);
index.addDoc(fullplan5);
index.addDoc(fullplan6);
index.addDoc(fullplan7);
index.addDoc(fullplan8);
index.addDoc(fullplan9);
index.addDoc(fullplan10);
index.addDoc(fullplan11);
index.addDoc(fullplan12);
index.addDoc(inlandFlooding1);
index.addDoc(inlandFlooding2);
index.addDoc(inlandFlooding3);
index.addDoc(inlandFlooding4);
index.addDoc(drought1);
index.addDoc(drought2);
index.addDoc(drought3);
index.addDoc(drought4);
index.addDoc(landslide1);
index.addDoc(landslide2);
index.addDoc(landslide3);
index.addDoc(landslide4);
index.addDoc(coastalFlooding1);
index.addDoc(coastalFlooding2);
index.addDoc(coastalFlooding3);
index.addDoc(coastalFlooding4);
index.addDoc(coastalErosion1);
index.addDoc(coastalErosion2);
index.addDoc(coastalErosion3);
index.addDoc(coastalErosion4);
index.addDoc(tsunami1);
index.addDoc(tsunami2);
index.addDoc(tsunami3);
index.addDoc(tsunami4);
index.addDoc(winterStorm1);
index.addDoc(winterStorm2);
index.addDoc(winterStorm3);
index.addDoc(winterStorm4);
index.addDoc(hurricanes1);
index.addDoc(hurricanes2);
index.addDoc(hurricanes3);
index.addDoc(hurricanes4);
index.addDoc(tornadoes1);
index.addDoc(tornadoes2);
index.addDoc(tornadoes3);
index.addDoc(tornadoes4);
index.addDoc(otherSevereWeather1);
index.addDoc(otherSevereWeather2);
index.addDoc(otherSevereWeather3);
index.addDoc(otherSevereWeather4);
index.addDoc(avgExtTemp1);
index.addDoc(avgExtTemp2);
index.addDoc(avgExtTemp3);
index.addDoc(avgExtTemp4);
index.addDoc(wildfires1);
index.addDoc(wildfires2);
index.addDoc(wildfires3);
index.addDoc(wildfires4);
index.addDoc(tornadoes1);
index.addDoc(tornadoes2);
index.addDoc(tornadoes3);
index.addDoc(tornadoes4);
index.addDoc(earthquakes1);
index.addDoc(earthquakes2);
index.addDoc(earthquakes3);
